...
object UpdateUserCommandRequestToCommandMapper : ObjectMappie<UpdateUserCommandRequest, UpdateUserCommand>() {
    override fun map(from: UpdateUserCommandRequest) = mapping {
        ...
        UpdateUserCommand::prefix fromValue { from.request.prefix }
        UpdateUserCommand::lastName fromValue { from.request.lastName }
        UpdateUserCommand::newsletter fromValue { from.request.newsletter!! }
        UpdateUserCommand::addressId fromValue { from.request.addressId }
        UpdateUserCommand::discord fromValue { from.request.discord }
        UpdateUserCommand::phoneNumber fromValue { from.request.phoneNumber }
