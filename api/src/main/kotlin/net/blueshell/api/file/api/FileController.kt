...
class FileController(service: FileService, repository: FileRepository, private val fileMapper: FileMapper) :
    ...
    fun uploadEventBanner(
        @RequestPart("file") @NotNull(message = "File is required") @net.blueshell.api.file.api.validation.FileSize(max = 2 * 1024 * 1024) @net.blueshell.api.file.api.validation.AllowedContentTypes(
            "image/png",
            "image/jpeg",
            "image/jpg",
            "image/webp",
