...
class QuestionEventListener {
    private val answers: AnswerService? = null
    private val signUps: EventSignUpService? = null
    ...
    fun onPersist(evt: PostPersistEvent<Question>) {
        ...
        QuestionEventListener.log.info("On persist question {}", q.getId())
    ...
    fun onUpdate(evt: PostUpdateEvent<Question>) {
        ...
        QuestionEventListener.log.info("Question update dirty fields: {}", q.getDirtyFields())
