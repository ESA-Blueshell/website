...
@Table(
    name = "blogs",
    uniqueConstraints = [UniqueConstraint(name = "uk_blogs_title_deleted_at", columnNames = ["title", "deleted_at"])],
    indexes = [Index(name = "idx_blogs_deleted_at", columnList = "deleted_at"), Index(
        name = "idx_blogs_title",
        columnList = "title"
    ), Index(name = "idx_blogs_published_at", columnList = "published_at"), Index(
