-- Concern(s): files url->path rename; event_banners creation and initial backfill

/* =========================
   (1/2/3/5) Files: structural change url->path with data move
   ========================= */
ALTER TABLE files
...
/* =========================
   (1/2/4) Event banners table + seed rows + indexes
   ========================= */
