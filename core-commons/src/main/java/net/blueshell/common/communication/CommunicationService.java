...
public class CommunicationService implements ICommunicationService {
    ...
    @Override
    public <T, T1> ResponseEntity<T> sendToFileService(String url, HttpMethod method,
                                                       T1 body, HashMap<String, Object> parameters,
                                                       Class<T> responseType) {
        return new FileCommunicator().sendSync(url, method, body, parameters, responseType);
    }
}
