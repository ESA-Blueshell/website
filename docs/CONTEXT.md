...
Granting one to somebody without two-factor signs them out everywhere. Their next
sign-in counts as a step-up, so setting up two-factor there starts at the phone rather
than with the password they have just given.
