...
recorded from a user's own page, or the reminder and incasso bulk actions. Those send
email and carry their own audit rows; this flow only writes contribution records.
