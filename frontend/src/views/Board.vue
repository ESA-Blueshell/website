...
const theme = (typeof useTheme === "function" ? useTheme() : null) as ReturnType<typeof useTheme> | null
...
const boards = ref<Board[]>([
  ...
  },
  {
    ...
    members: [
      {name: "Amber \"Ambanana\" Scholtz", title: "Chair", image: $require("@/assets/board6pics/amber.jpg")},
      {name: "Thomas \"ItIsIThomas\" Dekker", title: "Treasurer", image: $require("@/assets/board6pics/thomas.jpg")},
      {
...
boards.value.forEach((_, index: number) => {
...
function getMemberCardStyle(i: number, image?: string): CSSProperties {
  ...
  return {
    ...
    position: "relative",
    backgroundImage: `linear-gradient(${angle}, transparent 25%, ${bg} 34%, transparent 26%), ${url}`,
...
function getMemberInfoStyle(i: number): CSSProperties {
  const leftSide = i % 2 === 0
  return {
    position: "absolute",
    top: "50%",
