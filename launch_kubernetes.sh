kubectl apply -f kubernetes/configs/mariadb-init-configmap.yaml
kubectl apply -f kubernetes/configs/app-configmap.yaml
kubectl apply -f kubernetes/configs/db-configmap.yaml
kubectl apply -f kubernetes/configs/rabbit-configmap.yaml
...
kubectl apply -f email-parser/email-parser-deployment.yaml
...
kubectl apply -f email-parser/email-parser-service.yaml
