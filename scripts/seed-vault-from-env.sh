...
append_field secret/platform/mail bounce-mailbox-user "$(first_value EMAIL_BOUNCE_IMAP_USERNAME BOUNCE_MAILBOX_USER 2>/dev/null || true)"
append_field secret/platform/mail bounce-mailbox-password "$(first_value EMAIL_BOUNCE_IMAP_PASSWORD BOUNCE_MAILBOX_PASSWORD 2>/dev/null || true)"
