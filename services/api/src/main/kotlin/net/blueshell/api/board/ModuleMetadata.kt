package net.blueshell.api.board

import org.springframework.modulith.ApplicationModule
import org.springframework.modulith.PackageInfo

/**
 * The association's boards by year, the members on them and the documents a board publishes.
 *
 * A board member's `user` is nullable on purpose: most people who have sat on a board never had
 * an account here, so an unlinked membership still records the board that sat.
 */
@PackageInfo
@ApplicationModule(
    id = "board",
