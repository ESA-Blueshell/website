...
class ContributionPeriodController
    @Autowired
    constructor(
        ...
        @PermitAll
        fun findContributionPeriods(): List<ContributionPeriodResponse> = service.findAll().map { it.asResponse() }
        ...
        fun createContributionPeriod(
            @Valid @RequestBody request: CreateContributionPeriodRequest,
        ): ContributionPeriodResponse {
            val contributionPeriod =
                useCases.create(
