...
//            consentGdpr = true,
//            prefix = null,
//            initials = (firstName.firstOrNull()?.toString() ?: "X") + (lastName.firstOrNull()?.toString() ?: "X"),
//            phoneNumber = TODO(),
//            discord = TODO(),
//            steamid = TODO(),
//            contactId = TODO(),
...
//    }
//
//    private fun createAddressEntity(user: User): Address =
//        Address(
//            user = user,
//            country = "Netherlands",
//            city = "Amsterdam",
...
//        if (total == 0) return
//
//        val desiredPaid = round(total * ratio).toInt()
