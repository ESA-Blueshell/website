 ...
 * each row still come from the table the page already loaded; only the disposition and
 * the date are the server's to say.
 */
@Schema(name = "BulkMembershipPreview")
data class BulkMembershipPreview(
    /**
