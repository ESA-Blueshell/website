...
class CrossModuleWebAccessArchitectureTest : ArchJUnitTestBase(ArchitecturePackages.ROOT) {
    ...
    private companion object {
        ...
        val PINNED = setOf(
            ...
            "auth -> net.blueshell.api.domain.user.web.mapping.request.MemberProfileRequestMappingsKt",
            "auth -> net.blueshell.api.domain.user.web.mapping.request.UserRequestMappingsKt",
            "blog -> net.blueshell.api.shared.web.BaseController",
            "cohort -> net.blueshell.api.platform.integration.job.web.port.JobSubject",
            "cohort -> net.blueshell.api.platform.integration.job.web.port.JobSubjectResolver",
            "committee -> net.blueshell.api.shared.web.AdvancedController",
            "config -> net.blueshell.api.domain.user.web.dto.response.MemberProfileResponse",
            ...
            "contribution -> net.blueshell.api.platform.integration.job.web.port.JobSubject",
            "contribution -> net.blueshell.api.platform.integration.job.web.port.JobSubjectResolver",
            "contribution -> net.blueshell.api.shared.web.BaseController",
            "event -> net.blueshell.api.domain.survey.web.dto.request.AnswerRequest",
            "event -> net.blueshell.api.domain.survey.web.dto.request.SurveyRequest",
            "event -> net.blueshell.api.domain.survey.web.dto.response.AnswerResponse",
            "event -> net.blueshell.api.domain.survey.web.dto.response.SurveyResponse",
            "event -> net.blueshell.api.domain.survey.web.mapping.request.SurveyRequestMappingsKt",
            "event -> net.blueshell.api.domain.survey.web.mapping.response.SurveyResponseMappingsKt",
            "event -> net.blueshell.api.domain.user.web.dto.response.UserSummaryResponse",
            "event -> net.blueshell.api.domain.user.web.mapping.response.UserResponseMappingsKt",
            "event -> net.blueshell.api.platform.integration.job.web.port.JobSubject",
            "event -> net.blueshell.api.platform.integration.job.web.port.JobSubjectResolver",
