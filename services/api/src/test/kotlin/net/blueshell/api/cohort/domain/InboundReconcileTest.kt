...
class InboundReconcileTest {
    ...
    private fun givenContributionTarget() = givenTarget(CohortSubjectType.PERIOD_PAYERS, "PERIOD_PAYERS:12", scope = 12L)

    private fun givenNewsletterTarget() = givenTarget(CohortSubjectType.NEWSLETTER_SUBSCRIBERS, "NEWSLETTER_SUBSCRIBERS", scope = null)
