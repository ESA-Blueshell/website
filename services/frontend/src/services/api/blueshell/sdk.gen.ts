...
export const previewReminder = <ThrowOnError extends boolean = false>(options: Options<PreviewReminderData, ThrowOnError>) => (options.client ?? client).post<PreviewReminderResponses, PreviewReminderErrors, ThrowOnError>({
    responseType: 'json',
...
export const previewIncassoNotification = <ThrowOnError extends boolean = false>(options: Options<PreviewIncassoNotificationData, ThrowOnError>) => (options.client ?? client).post<PreviewIncassoNotificationResponses, PreviewIncassoNotificationErrors, ThrowOnError>({
    responseType: 'json',
