...
export const listSystems = <ThrowOnError extends boolean = false>(options?: Options<ListSystemsData, ThrowOnError>) => (options?.client ?? client).get<ListSystemsResponses, ListSystemsErrors, ThrowOnError>({
    responseType: 'json',
...
export const reconcile = <ThrowOnError extends boolean = false>(options: Options<ReconcileData, ThrowOnError>) => (options.client ?? client).post<ReconcileResponses, ReconcileErrors, ThrowOnError>({
    responseType: 'json',
    url: '/management/cohort-subjects/{id}/drift/reconcile',
    ...options
});

export const removeExternal = <ThrowOnError extends boolean = false>(options: Options<RemoveExternalData, ThrowOnError>) => (options.client ?? client).post<RemoveExternalResponses, RemoveExternalErrors, ThrowOnError>({
    responseType: 'json',
