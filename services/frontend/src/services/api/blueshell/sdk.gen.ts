...
export const markUnpaid = <ThrowOnError extends boolean = false>(options: Options<MarkUnpaidData, ThrowOnError>) => (options.client ?? client).post<MarkUnpaidResponses, MarkUnpaidErrors, ThrowOnError>({
    responseType: 'json',
...
export const applyInboundReconcile = <ThrowOnError extends boolean = false>(options: Options<ApplyInboundReconcileData, ThrowOnError>) => (options.client ?? client).post<ApplyInboundReconcileResponses, ApplyInboundReconcileErrors, ThrowOnError>({
    responseType: 'json',
...
export const previewInboundReconcile = <ThrowOnError extends boolean = false>(options: Options<PreviewInboundReconcileData, ThrowOnError>) => (options.client ?? client).post<PreviewInboundReconcileResponses, PreviewInboundReconcileErrors, ThrowOnError>({
    responseType: 'json',
