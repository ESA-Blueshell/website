...
export const forwardAuth = <ThrowOnError extends boolean = false>(options?: Options<ForwardAuthData, ThrowOnError>) => (options?.client ?? client).get<ForwardAuthResponses, ForwardAuthErrors, ThrowOnError>({ url: '/infra/forward-auth', ...options });
