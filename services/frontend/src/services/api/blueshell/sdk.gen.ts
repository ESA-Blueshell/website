...
export const saveAddress = <ThrowOnError extends boolean = false>(options: Options<SaveAddressData, ThrowOnError>) => (options.client ?? client).post<SaveAddressResponses, SaveAddressErrors, ThrowOnError>({
    url: '/signup/address',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const updateDetails = <ThrowOnError extends boolean = false>(options: Options<UpdateDetailsData, ThrowOnError>) => (options.client ?? client).patch<UpdateDetailsResponses, UpdateDetailsErrors, ThrowOnError>({
    url: '/signup/details',
    ...options,
    headers: {
        'Content-Type': 'application/json',
...
export const correctEmail = <ThrowOnError extends boolean = false>(options: Options<CorrectEmailData, ThrowOnError>) => (options.client ?? client).patch<CorrectEmailResponses, CorrectEmailErrors, ThrowOnError>({
    url: '/signup/email',
    ...options,
    headers: {
        'Content-Type': 'application/json',
