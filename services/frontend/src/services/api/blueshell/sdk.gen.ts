...
export const executeBulk = <ThrowOnError extends boolean = false>(options: Options<ExecuteBulkData, ThrowOnError>) => (options.client ?? client).post<ExecuteBulkResponses, ExecuteBulkErrors, ThrowOnError>({
    responseType: 'json',
...
export const previewBulk = <ThrowOnError extends boolean = false>(options: Options<PreviewBulkData, ThrowOnError>) => (options.client ?? client).post<PreviewBulkResponses, PreviewBulkErrors, ThrowOnError>({
    responseType: 'json',
