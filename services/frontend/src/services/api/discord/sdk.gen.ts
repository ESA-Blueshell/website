 ...
 */
export const getGuildJoinRequests = <ThrowOnError extends boolean = false>(options: Options<GetGuildJoinRequestsData, ThrowOnError>) => (options.client ?? client).get<GetGuildJoinRequestsResponses, GetGuildJoinRequestsErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const actionGuildJoinRequest = <ThrowOnError extends boolean = false>(options: Options<ActionGuildJoinRequestData, ThrowOnError>) => (options.client ?? client).patch<ActionGuildJoinRequestResponses, ActionGuildJoinRequestErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
