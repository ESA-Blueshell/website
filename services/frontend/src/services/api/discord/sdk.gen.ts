...
export const guildSearch = <ThrowOnError extends boolean = false>(options: Options<GuildSearchData, ThrowOnError>) => (options.client ?? client).get<GuildSearchResponses, GuildSearchErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ name: 'Authorization', type: 'apiKey' }],
