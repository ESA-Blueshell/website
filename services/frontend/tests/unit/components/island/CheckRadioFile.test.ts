...
describe("FileInput", () => {
  it("says what was chosen, and lets it be taken off again", async () => {
    ...
    const wrapper = mount(FileInput, {props: {modelValue: chosen, testid: "poster"}})
  ...
  it("shows a picture as a picture", () => {
    ...
    const wrapper = mount(FileInput, {props: {modelValue: shot}})
  ...
  it("shows anything else by kind, with its weight", () => {
    ...
    const wrapper = mount(FileInput, {props: {modelValue: paper}})
