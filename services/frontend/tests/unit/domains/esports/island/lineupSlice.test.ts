...
describe("a season's game as a slice", () => {
  it("names the game from its record and counts the teams it fielded", () => {
    const slice = lineupSliceOf({game: "VALORANT", teams: [team(1), team(2)], public: true}, identity, "/esports/valorant")

    expect(slice).toMatchObject({id: "VALORANT", title: "Valorant", meta: "2 teams this season", href: "/esports/valorant", banner: "/art.webp", accent: "#ff4655"})
  })
